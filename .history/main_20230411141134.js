  ...
  if (counter >= maxAttempts) {
    ...
    if (counter >= maxAttempts) {
      ...
      if (minObstacles === maxObstacles) {
        ...
        // Adiciona os pontos de início e fim da rota
        map.addLayer({
          id: "routePoints",
          type: "symbol",
          source: {
              ...
              features: [
                {
                  ...
                  geometry: {
                    type: "Point",
                    coordinates: bestRoute.features[0].geometry.coordinates,
                  },
                  properties: {
                    icon: "start",
                  },
                },
                {
                  ...
                  geometry: {
                    type: "Point",
                    coordinates: bestRoute.features[bestRoute.features.length - 1].geometry.coordinates,
                  },
                  properties: {
                    icon: "end",
                  },

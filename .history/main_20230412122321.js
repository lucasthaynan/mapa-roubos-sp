...
function noRoutes(element) {
  ...
  document.querySelector("section.container.pior-rota > p").innerHTML = `A pior rota registrou <strong>${percentualMinObstacles.toFixed(1)}% assaltos a menos</strong>, em 2022, em relação à média das rotas verificadas`
  // CONDIGO ANTIGO
  const card = document.createElement("div");
  card.className = "card";
  // Add the response to the individual report created above

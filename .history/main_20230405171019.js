      ...
      const directions = new MapboxDirections({
        ...
        steps: true
          ...
          // Add the steps to the individual report.
    const stepsContainer = report.appendChild(document.createElement('ol'));
    stepsContainer.className = 'steps';
    for (const step of route.steps) {
      const stepItem = stepsContainer.appendChild(document.createElement('li'));
      stepItem.innerHTML = step.maneuver.instruction;
    }

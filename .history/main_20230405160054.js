...
function traduzirInput(){
    let inputPartida = document.querySelector('.mapbox-directions-origin-input input[type="text"]')
    inputPartida.placeholder = "Endereço de partida"

    let inputDestido = document.querySelector('.mapbox-directions-destination-input input[type="text"]')
    inputDestido.placeholder = "Endereço de destino"
    console.log(input)  
}
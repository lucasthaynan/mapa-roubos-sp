      ...
      const map = new mapboxgl.Map({
        ...
        center: [-46.65601064382669, -23.561581155838063], // Specify the starting position [lng, lat]
...
function traduzirInput(){
    let input = document.querySelector('.mapboxgl-ctrl-geocoder > input[type="text"]')
    input.placeholder = "Endereço de partida"

    // let inputPartida = document.querySelector('.mapboxgl-ctrl-geocoder > input[type="text"]')
    // inputPartida.placeholder = "Endereço de partida"

    // let inputDestino = document.querySelector('.mapbox-directions-destination-input input[type="text"]')
    // inputDestino.placeholder = "Endereço de destino"

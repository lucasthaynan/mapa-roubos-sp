        ...
        if (counter >= maxAttempts) {
          ...
          for (const route of event.route) {
            ...
            if (clear === true) {
              ...
              emoji = '⚠️';
              const numberOfObstacles = turf.intersectCount(obstacle, routeLine);
                if (numberOfObstacles === 0) {
                map.setPaintProperty('theRoute', 'line-color', '#74c476'); // green
                } else if (numberOfObstacles <= 2) {
                map.setPaintProperty('theRoute', 'line-color', '#f5eb5c'); // yellow
                } else {
                map.setPaintProperty('theRoute', 'line-color', '#de2d26'); // red
                }

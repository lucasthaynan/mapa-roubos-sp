...
directions.on('waypoint', (event) => {
  // O parâmetro event contém informações sobre a alteração do waypoint
  console.log('Waypoint alterado', event.waypointIndex, event.waypoint);
});

...
directions.on("route", (event) => {
        ...
        if (counter >= maxAttempts) {
          ...
          for (const id in routesInfo) {
            ...
            if (obstacles < minObstacles) {
              ...
              console.log(
                "🚀 ~ file: main.js:235 ~ directions.on ~ minObstacles:",
                minObstacles
              );
              bestRoute = routeLine;
            }
          ...
          console.log(
            "🚀 ~ file: main.js:263 ~ directions.on ~ averageObstacles:",
            averageObstacles
          );

          console.log(
            `Número de obstáculos da rota com mais obstáculos: ${maxObstacles}`
          );
  ...
  } directions.on("clear", clearDirections);
});

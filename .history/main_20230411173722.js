...
directions.on("route", (event) => {
  ...
  // console.log("dados Rota:")
  // console.log(event)
  // Obtenha as coordenadas da origem

  // Obtem as coordenadas geográficas de A (origem) e B (destino)
  const origin = event.route[0].geometry.coordinates[0];
  const destination = event.route[0].geometry.coordinates[
    event.route[0].geometry.coordinates.length - 1
  ];

  // Faça o que precisar com as coordenadas de A e B
  console.log("Coordenadas de A:", origin);
  console.log("Coordenadas de B:", destination);

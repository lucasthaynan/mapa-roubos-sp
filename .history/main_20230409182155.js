    ...
    for (const route of event.route) {
      ...
      totalObstaculoRota =
        ...
        routesInfo[idRota] = {
         ...
         // Armazene o ID no array global
      routeIds.push(idRota);
...
// Crie uma função para remover as rotas testadas
function removeTestedRoutes(map) {
  ...
  // Limpe o array global de IDs das rotas
  routeIds.length = 0;
}

    ...
    for (const route of event.route) {
      ...
      if (clear === true) {
        ...
        if (counter >= maxAttempts) {
          ...
          for (const routeInfo of Object.values(routesInfo)) {
            if (routeInfo.clear && routeInfo.obstacles < minObstacles) {
              minObstacles = routeInfo.obstacles;
              bestRoute = routeInfo.routeLine;
            }
          }

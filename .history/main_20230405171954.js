      ...
      const obstacles = clearances.features.map(clearance => {
        const buffer = turf.buffer(clearance, clearance.properties.clearance / 1000, { units: 'kilometers' });
        return buffer;
      });
      
      const obstacle = turf.union(...obstacles);

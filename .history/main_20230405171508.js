      ...
      // Create buffer around clearance points
const buffer = turf.buffer(clearances, { units: 'kilometers', steps: 64 });

map.on('load', () => {
  // Add layer for buffer
  map.addLayer({
    id: 'obstacle-buffer',
    type: 'fill',
    source: {
  ...
  // Add layer for clearance points
  map.addLayer({
    id: 'clearances',
    type: 'circle',
    source: {

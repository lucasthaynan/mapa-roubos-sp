...
function traduzirInput(){
    ...
    document.querySelector('label[for="mapbox-directions-profile-traffic"]').innerText = "Trânsito"
    document.querySelector('label[for="mapbox-directions-profile-driving"]').innerText = "Carro"
    document.querySelector('label[for="mapbox-directions-profile-walking"]').innerText = "A pé"
    document.querySelector('label[for="mapbox-directions-profile-cycling"]').innerText = "Bicicleta"
